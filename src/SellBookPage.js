...
const initialBooks = [
  { id: 1, title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', price: 10.99, genre: 'Classic' },
  { id: 2, title: '1984', author: 'George Orwell', price: 9.99, genre: 'Dystopian' },
  { id: 3, title: 'To Kill a Mockingbird', author: 'Harper Lee', price: 12.49, genre: 'Fiction' },
  { id: 4, title: 'Pride and Prejudice', author: 'Jane Austen', price: 8.99, genre: 'Romance' },
  { id: 5, title: 'The Catcher in the Rye', author: 'J.D. Salinger', price: 11.99, genre: 'Classic' },
  { id: 6, title: 'Brave New World', author: 'Aldous Huxley', price: 10.49, genre: 'Science Fiction' },
  { id: 7, title: 'Moby Dick', author: 'Herman Melville', price: 9.49, genre: 'Adventure' },
  { id: 8, title: 'War and Peace', author: 'Leo Tolstoy', price: 14.99, genre: 'Historical' },
  { id: 9, title: 'Jane Eyre', author: 'Charlotte Brontë', price: 10.99, genre: 'Gothic' },
  { id: 10, title: 'The Hobbit', author: 'J.R.R. Tolkien', price: 13.99, genre: 'Fantasy' },
  { id: 11, title: 'Crime and Punishment', author: 'Fyodor Dostoevsky', price: 11.49, genre: 'Psychological' },
  { id: 12, title: 'The Lord of the Rings', author: 'J.R.R. Tolkien', price: 19.99, genre: 'Fantasy' },
  { id: 13, title: 'Fahrenheit 451', author: 'Ray Bradbury', price: 10.99, genre: 'Dystopian' },
  { id: 14, title: 'Wuthering Heights', author: 'Emily Brontë', price: 9.89, genre: 'Classic' },
  { id: 15, title: 'The Picture of Dorian Gray', author: 'Oscar Wilde', price: 8.99, genre: 'Philosophical' },
  { id: 16, title: 'Les Misérables', author: 'Victor Hugo', price: 13.49, genre: 'Historical' },
  { id: 17, title: 'Dracula', author: 'Bram Stoker', price: 9.99, genre: 'Horror' },
  { id: 18, title: 'The Alchemist', author: 'Paulo Coelho', price: 11.29, genre: 'Fable' },
  { id: 19, title: 'The Brothers Karamazov', author: 'Fyodor Dostoevsky', price: 12.99, genre: 'Philosophical' },
  { id: 20, title: 'Anna Karenina', author: 'Leo Tolstoy', price: 10.89, genre: 'Romance' },
  { id: 21, title: 'A Tale of Two Cities', author: 'Charles Dickens', price: 9.49, genre: 'Historical' },
  { id: 22, title: 'Don Quixote', author: 'Miguel de Cervantes', price: 14.59, genre: 'Adventure' },
  { id: 23, title: 'Frankenstein', author: 'Mary Shelley', price: 10.19, genre: 'Horror' }
];
...
const SellBookPage = () => {
  ...
  const saveEdit = (id) => {
    const updatedBooks = books.map((book) =>
      book.id === id
        ? { ...book, title: editFormData.title, author: editFormData.author, price: parseFloat(editFormData.price) }
        : book
    );
                ...
                <div className="card-body d-flex flex-column">
                  {editBookId === book.id ? (
                    ...
                    <>
                      ...
                      <div className="mt-3">
                        <button className="btn btn-primary me-2" onClick={() => handleBuyBook(book)}>Acheter</button>
                        {user?.role === "admin" && (
                          <>
